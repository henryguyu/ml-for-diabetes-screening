...
important_fields = "Ahr age WHR wc ADBP ASBP weight2 BMI ntime WHtR lgotosleep lvigtime lwork lmidtime lmidday hc lneverdrink lvigday walkhour orge0".split()
onehot_fields = "".split()
optional_fields = ["FPG"]
